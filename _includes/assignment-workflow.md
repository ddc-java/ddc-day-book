...
<aside class="assignment-workflow assignment-workflow--overview">
  ...
  <p>Your repository, workflow status, and published exercise contents are available from this page without leaving the assignment instructions.</p>
  <p class="assignment-workflow__actions">
    <a class="assignment-workflow__button" href="{{ site.github.repository_url | absolute_url }}">Repository</a>
    <a class="assignment-workflow__button external" href="{{ site.github.repository_url | absolute_url }}/actions">Actions</a>
  </p>
  <details>
  ...
  <details>
    <summary>Exercise contents</summary>
