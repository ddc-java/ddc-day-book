---
title: Overview
subtitle: "Basics of Jekyll/GitHub Pages site ."
order: 0
---
...
This theme is intended for sites with 5+ pages; in practice, the upper limits on pages will depend on the lengths of page menu labels: displaying a large number of entries in the page navigator sidebar implemented in this theme may not give &aelig;sthetically pleasing results.

Given the above, this theme should not, in its current form, be used for a site containing more than a few dozen pages.
